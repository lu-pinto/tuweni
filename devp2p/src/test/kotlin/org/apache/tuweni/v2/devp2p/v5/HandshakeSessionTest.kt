...
import org.apache.tuweni.v2.devp2p.v5.encrypt.SessionKeyGenerator
...
class HandshakeSessionTest {
  ...
  fun testConnectTwoClients() =
    runBlocking {
      val secretKey = SecretKey.fromBytes(MutableBytes.fromHexString("0x01").leftPad(32))
      val publicKey = PublicKey.fromSecretKey(secretKey)
      val keyPair = SECP256K1.KeyPair.create(secretKey, publicKey)
      val peerSecretKey = SecretKey.fromBytes(MutableBytes.fromHexString("0x02").leftPad(32))
