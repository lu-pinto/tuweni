 ...
 */
package org.apache.tuweni.v2.crypto;

import static java.nio.file.StandardOpenOption.READ;
import static org.apache.tuweni.io.file.Files.atomicReplace;
import static org.apache.tuweni.v2.crypto.Hash.keccak256;

import org.apache.tuweni.crypto.DecryptionException;
import org.apache.tuweni.crypto.EncryptionException;
...
public final class SECP256K1 {
  ...
  public static Bytes encrypt(SECP256K1.PublicKey publicKey, Bytes payload) {
    try {
      ...
      ECPublicKeySpec keySpec = new ECPublicKeySpec(ecPoint, Parameters.PARAMETER_SPEC);
  ...
  public static Bytes decrypt(SECP256K1.SecretKey secretKey, Bytes encrypted) {
    try {
      ECPrivateKeySpec keySpec = new ECPrivateKeySpec(secretKey.bytes().toUnsignedBigInteger(), Parameters.PARAMETER_SPEC);
      KeyFactory keyFactory = KeyFactory.getInstance("EC");
